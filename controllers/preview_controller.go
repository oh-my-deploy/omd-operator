...
//+kubebuilder:rbac:groups=omd.com,resources=previews,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=omd.com,resources=previews/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=omd.com,resources=previews/finalizers,verbs=update
